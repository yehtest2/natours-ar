...
var dispalyMap = function dispalyMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoieWVhaGpzb24iLCJhIjoiY2wyZDQ0em15MDMxdDNibXV0M3Bib2xjciJ9.I6_6bDSqyWnmTa4u9ZAajA';
  ...
  locations.forEach(function (element) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(element.coordinates).setHTML("<p>Day ".concat(element.day, ":").concat(element.description, "</p>")).addTo(map);
  });
...
},{"axios":"../../node_modules/axios/index.js"}],"updateData.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js"}],"scripe.js":[function(require,module,exports) {
"use strict";
...
var stripe = Stripe('pk_test_51KwnQSDTe7Lufc1lml9XRncub4ZfjIeGNMVCZoMxa0cwoGLjsthG6wssDDqfXx7yoIRcEJQoI7NAGBCZE2guNbmb00HUgVSVS0');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.default)("/api/v1/bookings/check-session/".concat(tourId));
...
if (SignForm) {
  SignForm.addEventListener('submit', function (e) {
    ...
    var password = document.getElementById('password').value;
    var PasswordConfrim = document.getElementById('PasswordConfrim').value;
    console.log(name, email, role, password, PasswordConfrim);
    (0, _signup.Signup)(name, email, role, password, PasswordConfrim);
  });
}
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateData.updateSettings)({
              password: password,
              passwordConfirm: passwordConfirm,
